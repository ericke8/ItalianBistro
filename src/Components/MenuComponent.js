            ...
            dishes: [
                {
                    ...
                    image: 'assets/images/meat_cheese_platter.jpg',
                    category: 'appetizer',
                    label: '',
                    price: '4.99',
                ...
                },
                {
                    ...
                    image: 'assets/images/chicken_fettucine_alfredo.jpg',
                    category: 'mains',
                    label: 'Hot',
                    price: '11.99',
                ...
                {
                    id: 2,
                    name: 'Meat Lover\'s Lasagna',
                    image: 'assets/images/meat_lasagna.jpg',
                    category: 'mains',
                    label: 'New',
                    price: '12.99',
                ...
                },
                {
                    ...
                    image: 'assets/images/tomato_basil_penne.jpg',
                    category: 'mains',
                    label: '',
                    price: '10.99',
        ...
        const menu = this.state.dishes.map((dish) => {
            return (
                <div key={dish.id} className="col-12 mt-5">
                    <Media tag="li">
                        <Media left middle>
                            <Media object src={dish.image} alt={dish.name} className='menuImage' />
                        </Media>
